...
Follow the basic [installation procedure](https://github.com/loco-3d/multicontact-locomotion-planning/blob/master/README.md#installation-procedure-) of this package  (including the installation of gepetto-viewer, but no other optional dependencies) and use the following script : 
